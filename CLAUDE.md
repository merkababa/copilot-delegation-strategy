...
- `templates/.github/copilot-instructions.md` — Copilot-specific review pipeline (6 reviewers, iterate to A+)
- `templates/.github/agents/` — All agent definitions (plan-executor, review-pipeline, 6 reviewers)
